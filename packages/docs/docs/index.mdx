...
Pyra has enabled the [Technical University of Munich](https://www.tum.de/en/) to collect continuous data from 5 stations around the city of Munich since 2019 using [MUCCnet](https://atmosphere.ei.tum.de/). Pyra versions 1 to 3 have been experimental tools improved internally since 2016.
...
-   How [the repository is organised](/docs/developer-guide/repository-organisation)
