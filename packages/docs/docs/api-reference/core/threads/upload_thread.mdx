...
Thread for uploading all interferograms from a specific directory to a server via SSH. 

The local files will only be removed (optional) if the files on the server generate the same MD5 checksum as the local files. 
...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/threads/upload_thread.py#L320" className="SourceCodeLinkBadge">source code</a>
...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/threads/upload_thread.py#L351" className="SourceCodeLinkBadge">source code</a>
...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/threads/upload_thread.py#L326" className="SourceCodeLinkBadge">source code</a>
...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/threads/upload_thread.py#L397" className="SourceCodeLinkBadge">source code</a>
