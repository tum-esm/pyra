...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/threads/helios_thread.py#L20" className="SourceCodeLinkBadge">source code</a>
...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/threads/helios_thread.py#L24" className="SourceCodeLinkBadge">source code</a>
...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/threads/helios_thread.py#L139" className="SourceCodeLinkBadge">source code</a>
...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/threads/helios_thread.py#L66" className="SourceCodeLinkBadge">source code</a>
...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/threads/helios_thread.py#L214" className="SourceCodeLinkBadge">source code</a>

### <kbd>method</kbd> `run`

```python
run(save_image: bool) → float
```
...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/threads/helios_thread.py#L116" className="SourceCodeLinkBadge">source code</a>
...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/threads/helios_thread.py#L79" className="SourceCodeLinkBadge">source code</a>
...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/threads/helios_thread.py#L234" className="SourceCodeLinkBadge">source code</a>
...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/threads/helios_thread.py#L260" className="SourceCodeLinkBadge">source code</a>
...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/threads/helios_thread.py#L265" className="SourceCodeLinkBadge">source code</a>
...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/threads/helios_thread.py#L252" className="SourceCodeLinkBadge">source code</a>
