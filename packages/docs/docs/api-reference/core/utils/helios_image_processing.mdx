...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/utils/helios_image_processing.py#L135" className="SourceCodeLinkBadge">source code</a>
...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/utils/helios_image_processing.py#L157" className="SourceCodeLinkBadge">source code</a>
...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/utils/helios_image_processing.py#L181" className="SourceCodeLinkBadge">source code</a>
