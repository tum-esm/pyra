...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/utils/helios_image_processing.py#L141" className="SourceCodeLinkBadge">source code</a>
...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/utils/helios_image_processing.py#L160" className="SourceCodeLinkBadge">source code</a>
