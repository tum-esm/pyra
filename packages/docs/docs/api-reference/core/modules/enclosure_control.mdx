...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/modules/enclosure_control.py#L233" className="SourceCodeLinkBadge">source code</a>
...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/modules/enclosure_control.py#L195" className="SourceCodeLinkBadge">source code</a>
...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/modules/enclosure_control.py#L178" className="SourceCodeLinkBadge">source code</a>
...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/modules/enclosure_control.py#L213" className="SourceCodeLinkBadge">source code</a>
