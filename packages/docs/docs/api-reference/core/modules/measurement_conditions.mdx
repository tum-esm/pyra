...
```python
is_time_trigger_active(config: Config) → bool
```
...
<a href="https://github.com/tum-esm/pyra/tree/main/packages/core/modules/measurement_conditions.py#L16" className="SourceCodeLinkBadge">source code</a>
