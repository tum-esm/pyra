...
Starting and stopping measurements and controlling PYRA from another system/automation will be covered in the next section [Measurements](/docs/user-guide/measurements).
