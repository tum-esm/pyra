...
CLI mode can be used when you have already built a system that evaluates measurement conditions, and want to use Pyra for the rest of the operation. Respective CLI commands can be found in the [next section](#cli-command-line-interface).
