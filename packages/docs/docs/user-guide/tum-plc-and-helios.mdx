...
The hardware for the TUM weather protection enclosure and Helios setup is not available to buy off the shelf yet. Please [contact us](/docs/intro/contact) if you are interested in acquiring our hardware.
