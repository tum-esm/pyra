...
<img src="/img/docs/python-310-path-automatic.png" className="tw-rounded-lg tw-mb-4" style={{ width: 600 }} />
...
<img src="/img/docs/environment-path-manual-1.png" className="tw-rounded-lg tw-mb-4" style={{ width: 600 }} />

2. Click on "Environment Variables"

<img src="/img/docs/environment-path-manual-2.png" className="tw-rounded-lg tw-mb-4" style={{ width: 600 }} />

3. Select "PATH" in the system section and click on "Edit"

<img src="/img/docs/environment-path-manual-3.png" className="tw-rounded-lg tw-mb-4" style={{ width: 600 }} />
