...
Our integration tests are conducted on two systems using **OPUS 7.8 and 8.2** and **CamTracker 3.9.2015.02.03**. Both OPUS and CamTracker are not really available to download, but you will receive them when buying an EM27/SUN system.
