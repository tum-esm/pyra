...
class DDEConnection:
    ...
    def setup(self, timeout: int = 60, attempts: int = 5) -> None:
        ...
        while True:
            ...
            self.logger.debug("Sleeping 2 minutes before retrying")
            time.sleep(120)
