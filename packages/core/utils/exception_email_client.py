...
class ExceptionEmailClient:
    ...
    def handle_resolved_exception(config: types.Config) -> None:
        ...
        html = (
            "<html>" + '  <body style="color: #0f172a;">' +
            '    <p><strong style="color: #16a34a">' +
            "      All exceptions have been resolved." + "    </strong></p>" +
            "    <p><em>" +
    ...
    def send_test_email(config: types.Config) -> None:
        ...
        text = (
            ...
            f"Last 2 iteration's log lines:{logs}\n\n" +
            "This email has been generated by Pyra 4 in a test run."
        )

        html = (
            "<html>" + '  <body style="color: #0f172a;">' +
            '    <p><strong style="color: #16a34a">' +
            "      This is a test email." + "    </strong></p>" +
            "    <p><em>" +
            "    <p><strong>Last 2 iteration's log lines:</strong></p>" +
            f"    {pre_tag}<code>{logs}</code></pre>" +
            "      This email has been generated by Pyra 4 in a test run." +
