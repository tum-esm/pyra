...
**The hierachy between the three parts of Pyra:**
...
What each module does is described on a high level in the paper (link coming soon) and in detail in the code's comments. We try to avoid duplicating information (code comments and documentation), because slightly out of sync descriptions can be very confising.
