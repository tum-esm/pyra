...
In order for PYRA to send you error emails (see [Usage section](/docs/user-guide/usage#error-emails)), you need an email account that allows this kind of connection.
...
There is a test script to test whether email sending works. See [/docs/developer-guide/repository-testing-and-ci](/docs/developer-guide/repository-testing-and-ci).
