...
The **PYRA Setup Tool** can be used to install and migrate between PYRA versions. The tool looks for the "Documents" directory on your system and generates a directory structure like this:
...
1. Downloads each releases codebaee
