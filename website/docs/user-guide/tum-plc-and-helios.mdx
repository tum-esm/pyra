...
The hardware for the TUM weather protection enclosure and Helios setup are not available to buy off the shelf yet. Please [contact us](/docs/contact) if you are interested in aquiring the same setup.
