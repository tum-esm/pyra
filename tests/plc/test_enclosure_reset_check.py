from packages.core.utils import ConfigInterface, STANDARD_PLC_INTERFACES, PLCInterface
...
def test_cover_movement():
    ...
    _PLC_INTERFACE: PLCInterface = STANDARD_PLC_INTERFACES[
        _CONFIG["tum_plc"]["version"]
    ]
